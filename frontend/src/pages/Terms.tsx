      ...
      <Paper p="xl" radius="md" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(10px)' }}>
        <Stack gap="xl">
          ...
          <div>
            ...
            <Text mb="md">
              Welcome to Fullstack (Family Alliance for Multi-generational International Legacy and Sustainability). 
          ...
          <div>
            ...
            <Text mb="md">
              By accessing or using Fullstack services, you acknowledge that you have read, understood, and agree to 
          ...
          <div>
            ...
            <Text mb="md">
              Fullstack provides a comprehensive platform for multi-generational financial management, including but 
          ...
          <div>
            ...
            <Text mb="md">
              ...
              provide to Fullstack. We are not responsible for any errors, omissions, or inaccuracies in the information 
          ...
          <div>
            ...
            <Text mb="md">
              ...
              logos, icons, images, and software, are the exclusive property of Fullstack and are protected by 
          ...
          <div>
            ...
            <Text mb="md">
              To the maximum extent permitted by law, Fullstack shall not be liable for any indirect, incidental, 
          ...
          <div>
            ...
            <Text mb="md">
              You agree to indemnify, defend, and hold harmless Fullstack, its officers, directors, employees, 
